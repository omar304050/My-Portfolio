...
const Services = () => {
  return (
    <div id="services" className="w-full px-[12%] py-10 scroll-mt-20">
      <h4 className="text-center mb-2 text-lg fontOvo">What I offer</h4>
      <h2 className="text-center text-5xl fontOvo">My Services</h2>
        ...
        {serviceData.map(({ icon, title, description, link }, index) => {
          return (
            <div
              ...
              hover:shadow-black cursor-pointer hover:bg-lightHover duration-500"
            >
