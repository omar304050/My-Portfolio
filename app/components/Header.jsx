  ...
  return (
    <div className="w-11/12 max-w-3xl text-center mx-auto flex flex-col justify-center items-center gap-4 h-screen ">
      ...
      <motion.h3
        ...
        className="flex items-end gap-2 text-xl md:text-2xl mb-3 fontOvo"
      >
        {" "}
        Hi Iam Omar Alalfy{" "}
      ...
      <motion.h1
        ...
        className="text-3xl sm:text-6xl lg:text-[66px] fontOvo"
      >
      ...
      <motion.p
        ...
        className="max-w-2xl ma-auto fontOvo"
      >
      ...
      <div className="flex flex-col sm:flex-row items-center  gap-4 mt-4">
        <motion.a
          ...
          href="#contact"
          className="px-10 py-3 border text-white border-white rounded-full bg-black flex items-center gap-2 dark:bg-transparent"
        >
          contact me{" "}
